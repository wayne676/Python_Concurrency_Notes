...
'''
process_threshold = partial(process_threshold, thresh_method=THRESH_METHOD)
partial fix the thread_method value to THRESH_METHOD and returns a new function to process_threshold
    also after partialization, you cannot pass argument to thresh_method otherwise you will get 
    got multiple values for argument 'thresh_method'
'''