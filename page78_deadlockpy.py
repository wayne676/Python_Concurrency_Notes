...
'''
try except will catch the exception but lock is never got released, last my_lock.acquire() will hang forever

get_data_from_file_v2 will solve the problem because of the with statement
